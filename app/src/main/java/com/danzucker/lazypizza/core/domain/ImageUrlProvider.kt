...
object ImageUrlProvider {
    ...
    fun getPizzaImageUrl(filename: String): String = "$BASE_URL/$PIZZA_FOLDER/$filename"

    fun getDrinkImageUrl(filename: String): String = "$BASE_URL/$DRINK_FOLDER/$filename"

    fun getIceCreamImageUrl(filename: String): String = "$BASE_URL/$ICE_CREAM_FOLDER/$filename"

    fun getSauceImageUrl(filename: String): String = "$BASE_URL/$SAUCE_FOLDER/$filename"

    fun getToppingImageUrl(filename: String): String = "$BASE_URL/$TOPPINGS_FOLDER/$filename"
